...
class TlsSignV1 implements TlsSignInterface
{
     ...
     * @throws \BiuBiuJun\QCloud\Exceptions\InvalidSignException
     */
    protected function makeSign(string $data)
    {
        $this->setPrivateKey();
        $sign = '';
     ...
     * @throws \BiuBiuJun\QCloud\Exceptions\InvalidSignException
     */
    protected function buildSignString(array $params, bool $userBuf = false)
    {
        $content = '';
     ...
     * @throws \BiuBiuJun\QCloud\Exceptions\InvalidSignException
     */
    protected function makeVerify(string $data, string $sign)
    {
        $this->setPublicKey();
